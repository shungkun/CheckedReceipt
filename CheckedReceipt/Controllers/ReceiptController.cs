...
namespace CheckedReceipt.Controllers
{
    ...
    public class Receipt
    {
        ...
        /// 比對開獎號碼
        /// </summary>
        /// <param name="strNumber">發票號碼</param> 00000000
        /// <param name="strIssue">期數</param> 110,01-03 年,月-月
        /// <returns>返回中獎金額，0則沒有中獎</returns>
        public static int CheckResult(string strNumber, string strIssue)
        {
            ReceiptPrize_Model ResultModel = new ReceiptPrize_Model();
            //特別獎 比對特別獎8碼
            if (strNumber == ResultModel.SpecialNumber)
            {
                return ResultModel.SpecialPrize;
            }
            //特獎 比對特獎8碼
            if (strNumber == ResultModel.GrandNumber)
            {
                return ResultModel.GrandPrize;
            }
            //頭獎 比對頭獎8碼
            if (strNumber == ResultModel.FirstNumber_1
                || strNumber == ResultModel.FirstNumber_2
                || strNumber == ResultModel.FirstNumber_3)
            {
                return ResultModel.FirstPrize;
            }
            //二獎 比對頭獎7碼
            if (strNumber[1..] == ResultModel.FirstNumber_1[1..]
               || strNumber[1..] == ResultModel.FirstNumber_2[1..]
               || strNumber[1..] == ResultModel.FirstNumber_3[1..])
            {
                return ResultModel.SecondPrize;
            }
            //三獎 比對頭獎6碼
            if (strNumber[2..] == ResultModel.FirstNumber_1[2..]
              || strNumber[2..] == ResultModel.FirstNumber_2[2..]
              || strNumber[2..] == ResultModel.FirstNumber_3[2..])
            {
                return ResultModel.ThirdPrize;
            }
            //四獎 比對頭獎5碼
            if (strNumber[3..] == ResultModel.FirstNumber_1[3..]
              || strNumber[3..] == ResultModel.FirstNumber_2[3..]
              || strNumber[3..] == ResultModel.FirstNumber_3[3..])
            {
                return ResultModel.FourthPrize;
            }
            //五獎 比對頭獎4碼
            if (strNumber[4..] == ResultModel.FirstNumber_1[4..]
              || strNumber[4..] == ResultModel.FirstNumber_2[4..]
              || strNumber[4..] == ResultModel.FirstNumber_3[4..])
            {
                return ResultModel.FifthPrize;
            }
            //六獎 比對頭獎3碼
            if (strNumber[5..] == ResultModel.FirstNumber_1[5..]
              || strNumber[5..] == ResultModel.FirstNumber_2[5..]
              || strNumber[5..] == ResultModel.FirstNumber_3[5..])
            {
                return ResultModel.SixthPrize;
            }
            //增開獎 比對增開獎 
            if (!string.IsNullOrEmpty(ResultModel.ExtraNumber_1))
            {
                if (strNumber.Substring(strNumber.Length - ResultModel.ExtraNumber_1.Length) == ResultModel.ExtraNumber_1)
                {
                    return ResultModel.ExtraPrize;
                }
            }
            if (!string.IsNullOrEmpty(ResultModel.ExtraNumber_2))
            {
                if (strNumber.Substring(strNumber.Length - ResultModel.ExtraNumber_2.Length) == ResultModel.ExtraNumber_2)
                {
                    return ResultModel.ExtraPrize;
                }
            }
